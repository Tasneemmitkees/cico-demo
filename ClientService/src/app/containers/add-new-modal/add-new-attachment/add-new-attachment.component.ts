...
@Component({
  ...
  templateUrl: './add-new-attachment.component.html'
})
export class AddNewAttachmentComponent implements OnInit {
  ...
  onSubmit(){
    ...
    {
      // console.log("new Attachment",this.attachmentForm.value);
      // console.log(this.custObjectID)
