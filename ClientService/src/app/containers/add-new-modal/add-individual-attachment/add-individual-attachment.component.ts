...
@Component({
  selector: 'app-add-individual-attachment',
  templateUrl: './add-individual-attachment.component.html'
})
export class AddIndividualAttachmentComponent implements OnInit {
  ...
  constructor(private fb:FormBuilder,
              ...
              private indivdidualAccService:IndividualServiceService) { }
  ...
  onSubmit(){
    if(this.attachmentForm.valid)
    {
      ...
      this.indivdidualAccService.addAttachement(attachement).subscribe();
  ...
  onUploadSuccess(event): void {
    ...
    //console.log("binary",this.files.slice(28))
    }
